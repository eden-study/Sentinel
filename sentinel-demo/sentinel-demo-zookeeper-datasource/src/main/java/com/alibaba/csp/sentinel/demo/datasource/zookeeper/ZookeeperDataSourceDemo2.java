 ...
 * @author guonanjun
 */
public class ZookeeperDataSourceDemo2 {

	private static final String KEY = "TestResource2";

    public static void main(String[] args) {
		System.setProperty("csp.sentinel.app.name", "ZookeeperDataSourceDemo");
    ...
    private static void loadRules() {
        ...
        final String path = "/Sentinel-Config/SYSTEM-CODE-DEMO-FLOW";

        ReadableDataSource<String, List<FlowRule>> flowRuleDataSource = new ZookeeperDataSource<>(remoteAddress, path,
                source -> JSON.parseObject(source, new TypeReference<List<FlowRule>>() {}));
		System.out.println(flowRuleDataSource.getProperty().toString());
