 ...
 * @since 1.8.2
 */
public class AuthorityRuleNacosPublisher extends NacosPublisherTemplate<AuthorityRuleEntity> {

	private final NacosRuleProperties nacosRuleProperties;

	public AuthorityRuleNacosPublisher(
	...
	public String getDataId(String app) {
		return NacosRuleUtils.getDataId(app, nacosRuleProperties.getDataIdSuffix().getAuthRule());
	}
}
