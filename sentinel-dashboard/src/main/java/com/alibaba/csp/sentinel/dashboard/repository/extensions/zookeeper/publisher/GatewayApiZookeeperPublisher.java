 ...
 * @since 1.8.2
 */
public class GatewayApiZookeeperPublisher extends ZookeeperPublisherTemplate<ApiDefinitionEntity> {

	private final ZookeeperRuleProperties zookeeperRuleProperties;

	public GatewayApiZookeeperPublisher(
	...
	public String getPath(String app) {
		return ZookeeperRuleUtils.getPath(zookeeperRuleProperties.getRootPath(), app,
			zookeeperRuleProperties.getRulePath().getGatewayApi());
	}
}
