 ...
 * @since 1.8.2
 */
public class AuthorityRuleZookeeperPublisher
	extends ZookeeperPublisherTemplate<AuthorityRuleEntity> {

	private final ZookeeperRuleProperties zookeeperRuleProperties;

	public AuthorityRuleZookeeperPublisher(
	...
	public String getPath(String app) {
		return ZookeeperRuleUtils.getPath(zookeeperRuleProperties.getRootPath(), app,
			zookeeperRuleProperties.getRulePath().getAuthRule());
	}
}
