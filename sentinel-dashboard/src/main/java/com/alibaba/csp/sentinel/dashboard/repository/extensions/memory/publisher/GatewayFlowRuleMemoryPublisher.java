 ...
 * @since 1.8.2
 */
public class GatewayFlowRuleMemoryPublisher extends MemoryPublisherTemplate<GatewayFlowRuleEntity> {

	private final SentinelApiClient sentinelApiClient;

	public GatewayFlowRuleMemoryPublisher(AppManagement appManagement, SentinelApiClient sentinelApiClient) {
		super(appManagement);
