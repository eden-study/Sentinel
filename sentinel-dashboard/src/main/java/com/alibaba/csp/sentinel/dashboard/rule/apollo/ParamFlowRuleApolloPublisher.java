 ...
 * @since 1.8.2
 */
public class ParamFlowRuleApolloPublisher extends ApolloPublisherTemplate<ParamFlowRuleEntity> {

	private final ApolloRuleProperties apolloRuleProperties;

	public ParamFlowRuleApolloPublisher(
	...
	public String getDataId(String app) {
		return ApolloRuleUtils.getDataId(app, apolloRuleProperties.getDataId().getParamFlowRule());
	}
}
