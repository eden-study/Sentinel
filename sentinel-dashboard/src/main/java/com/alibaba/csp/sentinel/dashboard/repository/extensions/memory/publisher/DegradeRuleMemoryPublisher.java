 ...
 * @since 1.8.2
 */
public class DegradeRuleMemoryPublisher extends MemoryPublisherTemplate<DegradeRuleEntity> {

	private final SentinelApiClient sentinelApiClient;

	public DegradeRuleMemoryPublisher(AppManagement appManagement, SentinelApiClient sentinelApiClient) {
		super(appManagement);
