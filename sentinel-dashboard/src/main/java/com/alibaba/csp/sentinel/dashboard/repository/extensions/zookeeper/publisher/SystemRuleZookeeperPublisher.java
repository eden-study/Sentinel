 ...
 * @since 1.8.2
 */
public class SystemRuleZookeeperPublisher extends ZookeeperPublisherTemplate<SystemRuleEntity> {

	private final ZookeeperRuleProperties zookeeperRuleProperties;

	public SystemRuleZookeeperPublisher(
	...
	public String getPath(String app) {
		return ZookeeperRuleUtils.getPath(zookeeperRuleProperties.getRootPath(), app,
			zookeeperRuleProperties.getRulePath().getSystemRule());
	}
}
