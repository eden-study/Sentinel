 ...
 * @since 1.8.2
 */
public class SystemRuleApolloPublisher extends ApolloPublisherTemplate<SystemRuleEntity> {

	private final ApolloRuleProperties apolloRuleProperties;

	public SystemRuleApolloPublisher(
	...
	public String getDataId(String app) {
		return ApolloRuleUtils.getDataId(app, apolloRuleProperties.getDataId().getSystemRule());
	}
}
