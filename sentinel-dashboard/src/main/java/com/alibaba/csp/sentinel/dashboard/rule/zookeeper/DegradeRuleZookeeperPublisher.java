 ...
 * @since 1.8.2
 */
public class DegradeRuleZookeeperPublisher extends ZookeeperPublisherTemplate<DegradeRuleEntity> {

	private final ZookeeperRuleProperties zookeeperRuleProperties;

	public DegradeRuleZookeeperPublisher(
	...
	public String getPath(String app) {
		return ZookeeperRuleUtils.getPath(zookeeperRuleProperties.getRootPath(), app,
			zookeeperRuleProperties.getRulePath().getDegradeRule());
	}
}
