 ...
 * @since 1.8.2
 */
public class DegradeRuleNacosPublisher extends NacosPublisherTemplate<DegradeRuleEntity> {

	private final NacosRuleProperties nacosRuleProperties;

	public DegradeRuleNacosPublisher(
	...
	public String getDataId(String app) {
		return NacosRuleUtils.getDataId(app, nacosRuleProperties.getDataIdSuffix().getDegradeRule());
	}
}
