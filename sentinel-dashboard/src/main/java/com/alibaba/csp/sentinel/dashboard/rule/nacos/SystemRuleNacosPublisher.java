 ...
 * @since 1.8.2
 */
public class SystemRuleNacosPublisher extends NacosPublisherTemplate<SystemRuleEntity> {

	private final NacosRuleProperties nacosRuleProperties;

	public SystemRuleNacosPublisher(
	...
	public String getDataId(String app) {
		return NacosRuleUtils.getDataId(app, nacosRuleProperties.getDataIdSuffix().getSystemRule());
	}
}
